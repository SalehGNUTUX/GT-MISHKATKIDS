...
> **الطفلُ يُعلّم، والآليُّ يَستنير.** نظامٌ تعليميّ للأطفال (4–10 سنوات) بفكرةٍ معكوسة: **الطفل هو المعلّم** — يُعيدُ تعليم آليٍّ صديقٍ (روبو) فقَدَ ذاكرته، فيتعلّمُ وهو يُعلّم، عبر أنشطةٍ واقعيّةٍ يفعلها بيديه. وكلّما علّمه ذكرى، **أضاء جزءٌ من روبو واستعاد نشاطَه** — كأنّ الطفلَ يُنيرُ المِشكاة (نورَ العلم).
...
- **قلب الأدوار:** الطفلُ خبيرٌ واثق، والروبوت يُخطئ — أمانٌ عاطفيّ تامّ.
...
| المكوّن | الملف | الوصف |
|---|---|---|
| 🤖 التطبيق (الحلقة) | `index.html` | شرارة → مهمة → تلقين → شفاء؛ روبو يتعافى أمام العين |
...
| 🎮 ألعاب وأنشطة | `play.html` | مركز ألعاب: لعبة الذاكرة + 7 ألعاب لدمج الحروف (قطار · مشابك · مكعّبات · صيد · بطاقات · متاهة · عجلة) + أنشطة للطباعة (أصيلة) |
...
| 🖨️ المطبوعات | `print.html` | بطاقات مهام + ملصق «خريطة شفاء روبو» (طباعة/PDF) |
...
- **نموذج الشفاء:** 7 أجزاء لروبو (عينان · أذنان · فم · قلب · يدان · ساقان · دماغ) + 7 عناصر عالم (قمر · شمس · شجرة · صديق · نهر · نجمة · طائر)، و**تعودُ ضحكةُ روبو** عند استعادة 8 مكافآت.

---

## 🔁 كيف تعمل الجلسة
1. **الشرارة:** يومضُ في روبو طيفُ ذكرى («أتذكّرُ كلمةً… دائرة؟ لكنّي نسيتُ شكلها!»).
...
4. **الشفاء:** يُضيءُ جزءٌ من روبو بلونه، ويرتفعُ التقدّم — والطفلُ هو من أعاده إلى الحياة.
