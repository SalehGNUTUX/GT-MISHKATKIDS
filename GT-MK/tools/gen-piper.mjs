...
const SYNTH_FIX = {
  ...
  // v1.7 (تعويضُ نطقِ العصبيّ): تكرارُ حرفِ المدِّ يُطيلُه، ووَاوٌ أخيرةٌ تُثبّتُ الضمّةَ التي يُسقِطُها النموذج.
  "الأَساسِيَّاتُ": "الأَساسِيَّااتُ",           // مدُّ الألفِ الأخير + تاءٌ مضمومة
  "المَطْبُوعاتُ": "المَطْبُوعااتُ",
  "اَلْجَمَلُ كَبِيرٌ": "اَلْجَمَلُ كَبِييرٌ",       // مدُّ ياءِ «كبير»
  "كَبِيرٌ": "كَبِييرٌ",
  "اَلسَّمَكُ يَسْبَحُ": "اَلسَّمَكُ يَسْبَحُو",     // تثبيتُ ضمّةِ الحاءِ الأخيرة
  "يَسْبَحُ": "يَسْبَحُو",
};
